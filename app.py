...
teams = ['Kolkata Knight Riders', 'Rajasthan Royals',
       ...
       'Rising Pune Supergiants', 'Gujarat Lions', 'Delhi Capitals', 'Punjab Kings',
...
if st.button('Predict Probability'):
    ...
    input_df = pd.DataFrame({'batting_team':[batting_team],'bowling_team':[bowling_team],'city':[selected_city],'runs_left':[runs_left],'balls_left':[balls_left],'wickets':[wickets],'target_runs':[target],'crr':[crr],'rrr':[rrr]})
